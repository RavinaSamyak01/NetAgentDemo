	...
	public void orderProcess3PLASTJOB() throws EncryptedDocumentException, InvalidFormatException, IOException {
		...
		for (int row = 6; row < 8; row++) {
			...
			try {
				...
				getScreenshot(Driver, "NoData1_3PLAST_Error");
				...
				try {
					...
					getScreenshot(Driver, "OnBoard_3PLAST_Error");
					...
					try {
						...
						logger.error(stage);
						getScreenshot(Driver, "stage_3PLAST_Error");
						try {
							String Orderstage2 = Driver.findElement(By.xpath("//Strong/span[@class=\"ng-binding\"]"))
									.getText();
							...
							logger.error(SName);
							getScreenshot(Driver, "SName_3PLAST_Error");
